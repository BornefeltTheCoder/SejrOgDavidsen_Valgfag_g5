...
<section class="fullWidth narrowHeader">
  ...
  <img src=<?php echo get_theme_file_uri("/assets/img/traeningHero.jpg" ) ?> alt="Hunde i træning" class="heroImg">
        ...
        <article class="hundeTræningCardSection">
          ...
          <div class="hundeTræningCards">
            ...
            <div class="hundeTræningCardsIndhold">
              ...
              <button type="button" class="btnYellow hundeTræningCardsBtn">Se pladser på hold</button>
            </div>
          </div>
          <div class="hundeTræningCards">
